...
public class StageController {
  ...
  public ResponseEntity<HttpResponse<Stage>> createStage(@RequestBody Stage stage)
      throws DuplicateStageNameInBoardException {
  ...
  public ResponseEntity<HttpResponse<Stage>> updateStage(@RequestBody Stage stage)
      throws DuplicateStageNameInBoardException, InvalidBoardIdException {
