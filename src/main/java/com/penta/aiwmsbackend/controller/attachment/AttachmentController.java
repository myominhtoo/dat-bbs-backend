...
public class AttachmentController {
    ...
    public ResponseEntity<HttpResponse<Attachment>> UploadFile(@PathVariable("activityId") Integer id,
            ...
            throws FileNotSupportException, IllegalStateException, IOException, InvalidActivityIdException,
            CustomFileNotFoundException, MultipartFileNotFoundException {
    ...
    public ResponseEntity<HttpResponse<Boolean>> deleteAttachment(@PathVariable("attachmentId") Integer id)
            throws MultipartFileNotFoundException {
    ...
    @GetMapping(value = "/boards/{boardId}/attachment-list")
    public List<Attachment> showAttachmentsList(@PathVariable("boardId") Integer boardId) {
