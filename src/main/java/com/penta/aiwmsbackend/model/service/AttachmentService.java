...
public class AttachmentService {
    ...
    public Attachment uploadFile(Attachment attachment) throws CustomFileNotFoundException, IllegalStateException,
            IOException, InvalidActivityIdException, MultipartFileNotFoundException {
        ...
        Activity activity = this.activityRepo.findById(attachment.getActivity().getId())
                .orElseThrow(() -> new InvalidActivityIdException("Activity id Not Found!"));
    ...
    public boolean deleteAttachment(int id) throws MultipartFileNotFoundException {
        ...
        Attachment attachment = this.attachmentRepo.findById(id)
                .orElseThrow(() -> new MultipartFileNotFoundException("File path Not found!"));
    ...
    public List<Attachment> findAttachmentList(Integer boardId) {
